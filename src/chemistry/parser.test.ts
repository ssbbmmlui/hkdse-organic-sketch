...
describe('HKDSE IUPAC parser', () => {
  ...
  it('parses haloalkanes', () => {
    ...
    expect(formula('1-bromo-2-chloropropane')).toBe('C3H6BrCl')
    expect(formula('3-bromo-5-methylheptane')).toBe('C8H17Br')
    expect(() => parseIupacName('5-bromo-3-methylheptane')).toThrow(NameError)
